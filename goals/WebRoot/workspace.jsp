...
<script type="text/javascript">
																						...
																						new CellRenderer(
																								{
																									render : function(
																										...
																										cell.innerHTML = "<a onclick=\" editableGridLearner.remove("
																												+ cell.rowIndex
	...
	function generateScenario() {
		...
		{
			alert("Select atleast one pedagogical objective");
			return false;
		}
...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="project.action?action=exit">Exit</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<ul class="nav nav-pills tabs-up" id="friends">
		...
		<li><a href="adaptationknowledge.action?action=show"
			...
			data-toggle="tabajax" rel="tooltip">Adaptation Knowledge</a></li>
		<li><a
			...
			data-toggle="tabajax" rel="tooltip">Scenario Generator</a></li>
	</ul>
