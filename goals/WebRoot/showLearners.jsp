	...
	function saveLearner() {
		...
		posting
				.done(function(data) {
					...
					$("#learnerMessages").html("Learner saved successfullt");
					//$('#myModal').modal('hide');
				});
	}
...
<body>
	...
	<ul class="nav nav-pills">
		<li><a href="project.action?action=logged" style="height: 5px; ">Projects</a></li>

		<li class="active"><a href="#">Learners</a></li>
	</ul>
		...
		<div class="col-sm-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Learners</h3>
				</div>
